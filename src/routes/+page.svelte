...
<main class="container mx-auto min-h-screen w-full max-w-screen-sm md:input-bordered md:border-x">
	<div class="flex h-full w-full flex-col gap-4 divide-y divide-base-content/10 pb-20 pt-1">
		{#each data as item}
			<PostCard data={item} />
		{/each}
	</div>
