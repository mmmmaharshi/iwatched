	...
	<section class="flex h-full w-full flex-col items-start justify-between gap-1 py-2 pr-4">
		<header>
			...
			<p class="text-base-content/85 line-clamp-1 text-sm">
				Dir. by <span class="font-medium">Ari Aster</span>
			</p>
		</header>
		<div class="flex flex-1 items-start">
			<p class="text-base-content/80 line-clamp-5 text-[12px] italic leading-tight">
				"Several friends travel to Sweden to study as anthropologists a summer festival that is held
				every ninety years in the remote hometown of one of them. What begins as a dream vacation in
				a place where the sun never sets, gradually turns into a dark nightmare as the mysterious
				inhabitants invite them to participate in their disturbing festive activities."
			</p>
		</div>
		<footer
